...
<div class="menu-mobile">
  <div class="menu-mobile-button-remove"><i class="far fa-times-circle"></i></div>
  <a href="<?=SERVER_DIR?>" class="transition">home</a> <?php include 'menu.php'; ?>
</div>
...
@media only screen and (min-device-width: 10px) and (max-device-width: 575px) {
  ...
  .menu-mobile-active{
      ...
      text-align: center;
  		...
  		animation: menu_slide_in 1s 1;
  		-webkit-animation: menu_slide_in 0.7s 1;
  		-moz-animation: menu_slide_in 0.7s 1;
  }
