<?php
  ...
  // HASH PASSWORD
  generatekeys();
  $crypted_password = encrypting("encrypt", $password, SECRET_KEY, SECRET_IV);

  // CREATE USER IN DATABASE
  $conn = db();
  $sk = SECRET_KEY;
  $iv = SECRET_IV;
  $sql = "INSERT INTO users (title, email, password, keypass, key_iv, key_tag, plan_id, created, updated, reference, active) VALUES('$name', '$email', '$crypted_password', '$crypted_password', '$sk', '$iv', '$plan', '$created', '$created', '$reference' ,'0')" ;
